...
- `SYNC_ECOSYSTEM_UNSUPPORTED`: `sync` stops while group memories exist; the PostgreSQL replica does not describe them yet. Local and remote data are not touched.
