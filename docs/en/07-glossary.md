...
An optional synchronized copy of the local Engram state. It does not replace SQLite or FTS5. Configure it with `init --json --postgres-url <URL>` and synchronize explicitly.
