...
import { CLIENT_IDS, LABELS, detectAssistants, type AssistantOptions, type AssistantDescriptor, type ClientId } from './assistants/catalog';
import { AssistantConfigurationError, applyAssistantConfiguration, planAssistantConfiguration, preflightAssistantConfiguration, type ConfigurationPlan } from './assistants/configuration';
import { renderAssistantScreen } from './assistant-tui-render';
import { testInstalledServer, type ServerTestResult } from './assistant-self-test';
