import type { Memory,MemoryVersion,SearchResult } from "../memory";
export type MemoryPreview=Omit<MemoryVersion,"content">&{preview:string;truncated:boolean};
export interface PreviewResult{memory:MemoryPreview;explanation:SearchResult["explanation"]}
export interface VersionRead{memory:MemoryVersion;currentVersion:number;state:Memory["state"]}
